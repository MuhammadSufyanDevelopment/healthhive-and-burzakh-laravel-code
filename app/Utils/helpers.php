...
//        $data['color_image'] = $color_image;
        ...
        foreach ($variation_arr as $var) {
            $variation[] = [
                'type' => isset($var['type']) ? $var['type'] : null,  // Default to null if 'type' doesn't exist
        'price' => isset($var['price']) ? (double)$var['price'] : 0.0, // Default to 0 if 'price' doesn't exist
        'sku' => isset($var['sku']) ? $var['sku'] : null, // Default to null if 'sku' doesn't exist
