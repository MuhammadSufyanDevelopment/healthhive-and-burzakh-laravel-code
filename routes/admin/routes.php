...
// Burzakh Master Admin
Route::post('/send-alert', [BurzakhAppController::class, 'storeAlert'])->name('send.alert');

Route::group(['prefix' => 'burzakh-master-admin'], function () {
    Route::get('dashboard', [BurzakhAppController::class, 'loadMasterAdminView']);
    
});
Route::get('/admin/fetch-entities', [BurzakhAppController::class, 'fetchEntitiesData']);
Route::post('/admin/register-case', [BurzakhAppController::class, 'userDocuemntSubmissionFromMaster'])->name('admin.registerCase');
Route::get('/admin/departments', [BurzakhAppController::class, 'loadDepartmentsData'])->name('admin.loadDepartmentsData');
Route::post('/admin/add-officer', [BurzakhAppController::class, 'addOfficer']);
...
Route::group(['prefix' => 'admin', 'as' => 'admin.', 'middleware' => ['admin']], function () {
    ...
    Route::group(['prefix' => 'customer', 'as' => 'customer.', 'middleware' => ['module:user_section']], function () {
        Route::controller(CustomerController::class)->group(function () {
            ...
            // Muhammad-Sufyan
            Route::get('verify-documents' . '/{user_id}', 'getVerifyDocumntsView')->name('verify-documents');
            ...
            Route::get('verify-documents/accept/{id}','updateDocumentVerification')->name('verify-documents.accept')->defaults('status', 1);
            Route::get('verify-documents/reject/{id}', 'updateDocumentVerification')->name('verify-documents.reject')->defaults('status', 2);
        });
