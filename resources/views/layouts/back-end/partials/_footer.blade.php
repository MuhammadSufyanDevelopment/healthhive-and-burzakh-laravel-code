    ...
    <div class="row justify-content-between align-items-center">
        <div class="col-lg-4 mb-2 mb-lg-0">
            <p class="font-size-sm mb-0 title-color text-center text-lg-left">
                ...
                <span class="d-none d-sm-inline-block">CopyRight Healthhive@2025</span>
            </p>
        </div>
        <div class="col-lg-8 mb-2 mb-lg-0">
            <div class="d-flex justify-content-center justify-content-lg-end">
                <ul class="list-inline list-footer-icon justify-content-center justify-content-lg-start mb-0">
                    ...
                    <a href="mailto:healthhive@gmail.com" target="_blank" >
                        <li class="list-inline-item">
                            <label class="badge badge-soft-version text-capitalize m-0" style="cursor: pointer;">
