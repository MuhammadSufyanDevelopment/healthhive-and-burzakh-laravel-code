                ...
                <table
                    ...
                    @foreach($customers as $key=>$customer)
                        <tr>
                            ...
                            <td>
                                <label class="btn text-info bg-soft-info font-weight-bold px-3 py-1 mb-0 fz-12">
                                    @if($customer['is_student'] == 1)
                                        Student
                                    @elseif($customer['is_vendor'] == 1)
                                        Vendor
                                    @elseif($customer['is_recruiter'] == 1)
                                        Recruiter
                                    @elseif($customer['is_health_care_worker'] == 1)
                                        Healthcare
                                    @else
                                        Customer
                                    @endif
                            ...
                            <td>
                                <div class="d-flex justify-content-center gap-2">
                                    ...
                                    @endif
                                    @if($customer['id'] != '0')
                                    <a title="{{translate('Verify Documents')}}"
                                        class="btn btn-outline-info btn-sm info square-btn verify-data"
                                        href="{{ route('admin.customer.verify-documents', ['user_id' => $customer['id']]) }}"
                                        data-id="customer-{{$customer['id']}}">
                                            <i class="tio-done"></i>
                                    </a>
                                    @endif
