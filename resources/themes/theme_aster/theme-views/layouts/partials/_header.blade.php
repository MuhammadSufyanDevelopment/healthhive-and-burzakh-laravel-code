    ...
    <!-- <div class="header-top py-2">
        <div class="container">
            <div class="d-flex align-items-center flex-wrap justify-content-between gap-2">
                <a href="tel:+971508402049" class="d-flex gap-2 align-items-center direction-ltr">
                ...
                <ul class="nav justify-content-center justify-content-sm-end align-items-center gap-4">
                    ...
                    @if($web_config['business_mode'] == 'multi' && $web_config['seller_registration'])
                        <li class="d-none d-xl-block">
                            ...
                            <a href="#" class="d-flex">
                                <div class="fz-16 text-capitalize">{{ translate('become_a_user')}}</div>
                            </a>
                        </li>
                    @endif
                </ul>
        ...
        <div class="container">
            <div class="d-flex align-items-center justify-content-between gap-3">
                <a class="logo" href="{{route('home')}}">
                    <img class="dark-support svg logo-size" alt="{{ translate('Logo') }}"
                ...
                <div>
                    <div class="aside-body" data-trigger="scrollbar">
                        ...
                        <ul class="main-nav nav">
                            ...
                            @if($web_config['business_mode'] == 'multi' &&  $web_config['seller_registration'])
                                <li class="d-xl-none">
                                    <a href="" class="d-flex text-capitalize">
                                        <div class="fz-16 text-capitalize">{{ translate('become_a_user')}}</div>
                                    </a>
                                </li>
                            @endif
                    ...
                    @else
                        <li class="login-register d-flex align-items-center gap-4">
                            ...
                            >
                                ...
                                <span
                                    class="media-body d-none d-xl-block hover-primary">{{ translate('login now')}}</span>
                            </button>
                            <div class="menu-btn d-xl-none">
                                <i class="bi bi-list fs-30"></i>
                            </div>
