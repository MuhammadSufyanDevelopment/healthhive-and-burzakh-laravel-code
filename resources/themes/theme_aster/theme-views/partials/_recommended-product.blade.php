    ...
    <div class="container">
        ...
        <nav class="d-flex justify-content-center">
            <div class="nav nav-nowrap gap-3 gap-xl-5 nav--tabs hide-scrollbar" id="nav-tab" role="tablist">
                ...
                <button class="active text-capitalize" data-bs-toggle="tab" data-bs-target="#best_selling" role="tab"
        ...
        <div class="card mt-3">
            <div class="p-2 p-sm-3">
                <div class="tab-content" id="nav-tabContent">
                    ...
                    <div class="tab-pane show active" id="best_selling" role="tabpanel" tabindex="0">
                        <div class="d-flex flex-wrap justify-content-end gap-3 mb-3">
