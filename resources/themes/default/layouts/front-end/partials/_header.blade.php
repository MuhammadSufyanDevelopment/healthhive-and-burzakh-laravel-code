        ...
        <div class="container">
            ...
            <div>
                <div class="topbar-text dropdown d-md-none ms-auto">
                    <a class="topbar-link direction-ltr" href="tel:+971508402049">
                        <i class="fa fa-phone"></i> +971508402049
                    </a>
                </div>
                <div class="d-none d-md-block mr-2 text-nowrap">
                    <a class="topbar-link d-none d-md-inline-block direction-ltr" href="tel:+971508402049">
                        <i class="fa fa-phone"></i> +971508402049
                    </a>
                </div>
            </div>
