                            ...
                            <div class="col-md-7">
                                ...
                                <div class="row text-start">
                                    <div class="col-12 start_address ">
                                        <div class="">
                                            <a class="widget-list-link" href="tel:+971508402049">
                                                <span class="">
                                        ...
                                        <div>
                                            <a class="widget-list-link"
                                               href="healthhive@gmail.com">
                                                <span><i class="fa fa-envelope  me-2 mt-2 mb-2"></i> healthhive@gmail.com </span>
                                            </a>
                                        </div>
                                        <div class="pe-3">
                                            <!-- @if(auth('customer')->check())
        ...
        <div class="bg-white-overlay-50">
            <div class="container">
                <div class="d-flex flex-wrap end-footer footer-end last-footer-content-align text-center pt-3 pb-4 py-md-0">
                    <div class="mt-3">
                        <p class="__text-16px">Copyrights Healthhive 2024</p>
                    </div>
                    <div
